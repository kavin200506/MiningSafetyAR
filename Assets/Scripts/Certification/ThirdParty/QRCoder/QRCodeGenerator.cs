...
// Trimmed to remove PayloadGenerator-dependent overloads (vCard/WiFi/etc. builders) which are unused here.
// Used by QRCodeTextureGenerator.cs to encode certificate verification URLs into scannable QR codes.
